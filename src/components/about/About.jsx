      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <p className="about__description">
            I am a passionate creative web developer with a deep love for the dynamic world of 3D web design. 
          ...
          <a download="" href={CV} className="button button--flex" style={{pointerEvents:"none"}}>
            Download CV
            <svg
              class="button__icon"
